...
public class ReferendumEntity {
    ...
    public List<ReferendumImageEntity> getImages() { return images; }

    public void setImages(List<ReferendumImageEntity> images) { this.images = images; }
    ...
    public String getOption9() { return option9; }

    public void setOption9(String option9) { this.option9 = option9; }
    ...
    public int getVotes3() { return votes3; }

    public void setVotes3(int votes3) { this.votes3 = votes3; }

    public int getVotes4() { return votes4; }

    public void setVotes4(int votes4) { this.votes4 = votes4; }

    public int getVotes5() { return votes5; }

    public void setVotes5(int votes5) { this.votes5 = votes5; }

    public int getVotes6() { return votes6; }

    public void setVotes6(int votes6) { this.votes6 = votes6; }

    public int getVotes7() { return votes7; }

    public void setVotes7(int votes7) { this.votes7 = votes7; }

    public int getVotes8() { return votes8; }

    public void setVotes8(int votes8) { this.votes8 = votes8; }

    public int getVotes9() { return votes9; }

    public void setVotes9(int votes9) { this.votes9 = votes9; }

    public int getVotes10() { return votes10; }

    public void setVotes10(int votes10) { this.votes10 = votes10; }
