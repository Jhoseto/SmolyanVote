...
export function CreateSimpleEventForm() {
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="flex flex-col gap-5">
      <div>
        <label htmlFor="se-title" className={labelClass}>
          Заглавие
        </label>
        <input id="se-title" type="text" maxLength={100} {...register("title")} className={inputClass} />
      ...
      <div>
        <label htmlFor="se-description" className={labelClass}>
          Описание
        </label>
        <textarea
          id="se-description"
      ...
      <div>
        <label htmlFor="se-location" className={labelClass}>
          Населено място
        </label>
        <select id="se-location" {...register("location")} className={inputClass}>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div>
          <label htmlFor="se-positive" className={labelClass}>
            Етикет „ЗА“
          </label>
          <input id="se-positive" type="text" maxLength={80} {...register("positiveLabel")} className={inputClass} />
          {errors.positiveLabel && <p className={errorClass}>{errors.positiveLabel.message}</p>}
        </div>
        <div>
          <label htmlFor="se-negative" className={labelClass}>
            Етикет „ПРОТИВ“
          </label>
          <input id="se-negative" type="text" maxLength={80} {...register("negativeLabel")} className={inputClass} />
          {errors.negativeLabel && <p className={errorClass}>{errors.negativeLabel.message}</p>}
        </div>
        <div>
          <label htmlFor="se-neutral" className={labelClass}>
            Неутрален етикет
          </label>
          <input id="se-neutral" type="text" maxLength={80} {...register("neutralLabel")} className={inputClass} />
