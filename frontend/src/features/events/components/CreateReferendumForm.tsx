...
export function CreateReferendumForm() {
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="flex flex-col gap-5">
      <div>
        <label htmlFor="ref-topic" className={labelClass}>
          Тема
        </label>
        <input id="ref-topic" type="text" maxLength={150} {...register("topic")} className={inputClass} />
      ...
      <div>
        <label htmlFor="ref-description" className={labelClass}>
          Описание
        </label>
        <textarea
          id="ref-description"
      ...
      <div>
        <label htmlFor="ref-location" className={labelClass}>
          Населено място
        </label>
        <select id="ref-location" {...register("location")} className={inputClass}>
