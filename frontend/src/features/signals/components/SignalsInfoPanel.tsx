      ...
      {open && (
        <div className="space-y-4 border-t border-primary/10 px-4 pb-4 pt-3 text-sm text-[color:var(--color-text-secondary)]">
          ...
          <section>
            ...
            <p>
              На desktop виждаш картата и списъка едновременно. На телефон превключвай между „Карта“ и
              „Списък“. Докосни маркер или карта, за да видиш детайли. Сподели линка, за да ангажираш
              съседи.
            </p>
          </section>
