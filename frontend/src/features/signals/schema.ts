...
/** Mirrors `SignalsEntity`/legacy `validateSignalInput` (title 5-200, description 10-2000, expiration 1|3|7 days). */
export const signalFormSchema = z.object({
  ...
  expirationDays: z.union([z.literal(1), z.literal(3), z.literal(7)]),
});
