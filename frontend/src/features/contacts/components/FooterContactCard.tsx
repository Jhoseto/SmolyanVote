...
/** Footer contact CTA — same card layout as the newsletter block. */
export function FooterContactCard({
  className,
  title = "Контакти",
  hint = "Въпроси и предложения",
  actionLabel = "Свържи се",
  ...
  return (
    ...
    >
      ...
      <ContactTrigger className="inline-flex h-9 shrink-0 items-center justify-center gap-1.5 rounded-[var(--radius-pill)] bg-[image:var(--gradient-primary)] px-4 text-xs font-semibold text-white shadow-[var(--shadow-sm)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--shadow-md)]">
